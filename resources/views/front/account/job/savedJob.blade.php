                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody class="border-0">
                                                        ...
                                                        <td>
                                                            <div class="action-dots float-end">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    {{-- <li><a class="dropdown-item" href="{{ route('account.editJob', $savedJob->job->id) }}">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="5" class="text-center">No jobs Applications found</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
...
@section('customJs')
    <script type="text/javascript">
        function removeJob(id) {
            if (confirm("Are your Sure You Want to Remove this Job? ")) {
                $.ajax({
