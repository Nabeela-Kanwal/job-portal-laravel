                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    <option value="10" {{ Request::get('experience') == 10 ? 'selected' : '' }}>10
                                        Years</option>experience
                                    <option value="10_plus"
                                        {{ Request::get('experience') == '10_plus' ? 'selected' : '' }}>10+ Years
                                    </option>
                                </select>
                            </div>
                            <button tyep="submit" class="btn btn-primary">Search</button>
                            <a href="{{ route('jobs') }}" tyep="reset" class="btn btn-secondary mt-3">Reset</a>
...
@section('customJs')
    <script>
        $("#searchForm").submit(function(e) {
            ...
            var keyword = $("#keyword").val(); // search by keyword
            var location = $("#location").val(); // search by location
            var category = $("#category").val(); // search by category
            var experience = $("#experience").val(); // search by experience
            var sort = $('#sort').val(); // search by order latest/oldest
